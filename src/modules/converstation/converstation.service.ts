...
export class ConverstationService implements IConverstation {
  ...
  async createConverstation(
    createConverstation: CreateConverstationDto,
  ): Promise<{
    status?: boolean;
    data?: Converstation;
    message?: string;
  ...
  async updateConverstation(
    id: string,
    updateConverstation: UpdateConverstationDto,
  ): Promise<{
    status?: boolean;
    data?: Converstation;
    message?: string;
    ...
    const converstation = await this.converstationModel.findByIdAndUpdate(
      id,
      updateConverstation,
    );
    if (converstation) {
  ...
  async deleteConverstation(id: string): Promise<{
    status?: boolean;
    data?: Converstation;
    message?: string;
    messageType?: number;
  ...
  async findByIdConverstation(id: string): Promise<{
    status?: boolean;
    data?: Converstation;
    message?: string;
    messageType?: number;
  ...
  async findConverstation(query: QueryDto): Promise<{
    status?: boolean;
    data?: Converstation[];
    message?: string;
    messageType?: number;
