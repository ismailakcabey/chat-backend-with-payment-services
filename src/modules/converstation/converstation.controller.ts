...
export class ConverstationController {
  constructor(private readonly converstationService: ConverstationService) {}
  ...
  @Post('/find')
  async findConverstation(@Body() query: QueryDto): Promise<{
    status?: boolean;
    message?: string;
    messageType?: number;
    data?: Converstation[];
  ...
  @Get(':id')
  async findByIdConverstation(@Param('id') id: string): Promise<{
    status?: boolean;
    message?: string;
    messageType?: number;
    data?: Converstation;
  ...
  async updateByIdConverstation(
    ...
    return await this.converstationService.updateConverstation(
      id,
      converstation,
    );
  }
  ...
  @Delete(':id')
  async deleteByIdConverstation(@Param('id') id: string): Promise<{
    status?: boolean;
    message?: string;
    messageType?: number;
    data?: Converstation;
